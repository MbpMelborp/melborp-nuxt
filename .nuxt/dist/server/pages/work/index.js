...
var add = __webpack_require__(5).default
module.exports.__inject__ = function (context) {
  add("93ce8f80", content, true, context)
};
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".work-top{margin-left:auto;margin-right:auto;width:100%;max-width:80rem;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;padding-top:11rem;line-height:1;}.work-top .work-header h2{margin-left:1rem;margin-right:1rem;}.work-top .work-header h2{font-size:2.25rem;line-height:2.5rem;}@media (min-width: 768px){.work-top .work-header h2{margin-left:0px;margin-right:0px;}}@media (min-width: 768px){.work-top .work-header h2{display:grid;}}@media (min-width: 768px){.work-top .work-header h2{grid-template-columns:repeat(12, minmax(0, 1fr));}}@media (min-width: 768px){.work-top .work-header h2{grid-template-rows:repeat(3, minmax(0, 1fr));}}@media (min-width: 768px){.work-top .work-header h2{-moz-column-gap:1rem;column-gap:1rem;}}@media (min-width: 768px){.work-top .work-header h2{row-gap:0px;}}@media (min-width: 768px){.work-top .work-header h2{font-size:3.75rem;line-height:1;}}.work-top .work-header h2 span{line-height:1;}@media (min-width: 768px){.work-top .work-header h2 span{display:block;}}.work-top .work-header h2 span.title_1{font-variation-settings:\"wght\" 200,\"wdth\" 130,\"ital\" 0;font-variation-settings:\"wght\" var(--font-weight,200),\"wdth\" var(--font-width,130),\"ital\" 0}.work-top .work-header h2 span.title_1{grid-column:span 1 / span 1;}.work-top .work-header h2 span.title_1{grid-row:span 1 / span 1;}.work-top .work-header h2 span.title_1{grid-row-start:1;}@media (min-width: 768px){.work-top .work-header h2 span.title_1{grid-column:span 8 / span 8;}}@media (min-width: 768px){.work-top .work-header h2 span.title_1{grid-column-start:2;}}.work-top .work-header h2 span.title_2{grid-row:span 1 / span 1;}.work-top .work-header h2 span.title_2{grid-row-start:2;}.work-top .work-header h2 span.title_2{text-transform:uppercase;}@media (min-width: 768px){.work-top .work-header h2 span.title_2{grid-column:span 6 / span 6;}}@media (min-width: 768px){.work-top .work-header h2 span.title_2{grid-column-start:6;}}.work-top .work-header h2 span.title_2,.work-top .work-header h2 span.title_3{font-variation-settings:\"wght\" 400,\"wdth\" 130,\"ital\" 0;font-variation-settings:\"wght\" var(--font-weight,400),\"wdth\" var(--font-width,130),\"ital\" 0}.work-top .work-header h2 span.title_3{grid-row:span 1 / span 1;}.work-top .work-header h2 span.title_3{grid-row-start:3;}.work-top .work-header h2 span.title_3{text-transform:uppercase;}@media (min-width: 768px){.work-top .work-header h2 span.title_3{grid-column:span 6 / span 6;}}@media (min-width: 768px){.work-top .work-header h2 span.title_3{grid-column-start:5;}}.work-list{margin-left:auto;margin-right:auto;min-height:100vh;width:100%;max-width:1536px;padding-top:5rem;}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/string-replace-loader??ref--15!./pages/work/index.vue?vue&type=template&id=1836cba7&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('LocomotiveScroll',{ref:"scroller",attrs:{"id":"melborp-team","getted-options":{
  ...
  }}},[_c('div',{class:'content_interior vertical' + (_vm.story != null ? ' loaded' : '')},[_c('div',{staticClass:"work-top",attrs:{"data-scroll-section":"","data-scroll-call":"section_team"}},[_c('div',{staticClass:"work-header"},[_c('h2',[(_vm.story.content.titulo[0].titulo1)?_c('span',{staticClass:"title_1"},[_vm._v(_vm._s(_vm.story.content.titulo[0].titulo1)+"\n          ")]):_vm._e(),_vm._v(" "),(_vm.story.content.titulo[0].titulo2)?_c('span',{staticClass:"title_2"},[_vm._v(_vm._s(_vm.story.content.titulo[0].titulo2)+"\n          ")]):_vm._e(),_vm._v(" "),(_vm.story.content.titulo[0].titulo3)?_c('span',{staticClass:"title_3"},[_vm._v(_vm._s(_vm.story.content.titulo[0].titulo3))]):_vm._e()])])]),_vm._v(" "),_c('div',{staticClass:"work-list",attrs:{"data-scroll-section":""}},[_c('div',{staticClass:"work-list-wrap"},_vm._l((_vm.story.content.proyectos),function(proyecto,i){return _c('Proyecto',{key:i,attrs:{"proyecto":proyecto}})}),1)])])])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/work/index.vue?vue&type=template&id=1836cba7&
...
// EXTERNAL MODULE: ./components/proyectos/ProyectoItem.vue + 4 modules
var ProyectoItem = __webpack_require__(167);
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/string-replace-loader??ref--15!./pages/work/index.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var workvue_type_script_lang_js_ = ({
  ...
  asyncData({
    ...
    try {
      if (payload) {
        ...
        const fullSlug = route.path === '/' || route.path === '' ? 'work' : route.path;
  ...
  methods: { ...Object(external_vuex_["mapMutations"])({
    ...
    setStyles() {
      setTimeout(() => {
        console.log('👌 WORK -> setTimeout', document.getElementById('nav_site'), this.story.content.colores[0]);
...
installComponents(component, {Proyecto: __webpack_require__(132).default})
